    ...
    return (
        <div className='flex justify-center flex-1 mt-32'>
            <div className='max-w-2xl p-3 mx-auto text-center'>
                <div>
                    <h1 className='text-3xl font-semibold text-center font my-7'>About Ankit' Blog</h1>
                    <div className='flex flex-col gap-6 text-gray-500 text-md'>
                        <p>
                            Welcome to Ankit's Blog! This blog was created by Ankit Yadav as a personal project to share
